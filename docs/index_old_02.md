...
[3. semestr :lucide-corner-right-down:](#3-semestr){ .md-button }
[4. semestr :lucide-corner-right-down:](#4-semestr){ .md-button }
{align=center style="display:flex; gap:10px 5%; justify-content:center; flex-wrap:wrap;"}
...
:material-numeric-2-box: 124UPST __Úvod do pozemního stavitelství__ __zk__{.examination}

:material-numeric-2-box: [Ing. Ctislav Fiala, Ph.D.](#){.lecturer target="_blank"}

:material-numeric-0-box: - - - - - - - - - - - -
[:material-calendar-month:{.schedule}](https://portal.fsv.cvut.cz/rozvrh/predmet/124UPST){target="_blank"}
...
:material-numeric-2-box: [doc. Ing. Rudolf Urban, Ph.D.](https://k154.fsv.cvut.cz/~urban/){.asistent_lecturer target="_blank"}
[:material-calendar-month:{.schedule}](https://portal.fsv.cvut.cz/rozvrh/predmet/154ACIG){target="_blank"}
...
:material-numeric-2-box: [prof. Ing. Martin Štroner, Ph.D.](https://k154.fsv.cvut.cz/~stroner/){.lecturer target="_blank"}

:material-numeric-2-box: [prof. Ing. Martin Štroner, Ph.D.](https://k154.fsv.cvut.cz/~stroner/){.asistent_lecturer target="_blank"}
[:material-calendar-month:{.schedule}](https://portal.fsv.cvut.cz/rozvrh/predmet/154ING2){target="_blank"}
...
:material-numeric-2-box: doc. RNDr. Jozef Bobok, CSc.
[:material-calendar-month:{.schedule}](https://portal.fsv.cvut.cz/rozvrh/predmet/101MM4G){target="_blank"}
...
:material-numeric-2-box: Ing. Jan Holešovský
[:material-calendar-month:{.schedule}](https://portal.fsv.cvut.cz/rozvrh/predmet/155TGD3){target="_blank"}
...
:material-numeric-2-box: prof. Ing. Jiří Cajthaml, Ph.D.
[:material-calendar-month:{.schedule}](https://portal.fsv.cvut.cz/rozvrh/predmet/155KAT3){target="_blank"}
...
[:material-calendar-month:{.schedule}](https://portal.fsv.cvut.cz/rozvrh/predmet/155DPRZ){target="_blank"}
...
[:material-calendar-month:{.schedule}](https://portal.fsv.cvut.cz/rozvrh/predmet/155GPL2){target="_blank"}
...
:material-numeric-2-box: Ing. Martin Landa, Ph.D.
[:material-calendar-month:{.schedule}](https://portal.fsv.cvut.cz/rozvrh/predmet/155UZPR){target="_blank"}
...
:material-numeric-2-box: doc. Ing. Tomáš Bayer, Ph.D.
[:material-calendar-month:{.schedule}](https://portal.fsv.cvut.cz/rozvrh/predmet/155YGEI){target="_blank"}
...
:material-numeric-2-box: doc. Ing. Tomáš Bayer, Ph.D.
[:material-calendar-month:{.schedule}](https://portal.fsv.cvut.cz/rozvrh/predmet/128TG){target="_blank"}
...
:material-numeric-2-box: Ing. Eliška Housarová, Ph.D.
[:material-calendar-month:{.schedule}](https://portal.fsv.cvut.cz/rozvrh/predmet/155YCN1){target="_blank"}
...
<style>
/* Targets all links inside the main Zensical/MkDocs content area */
.md-typeset .study_plan a {
    color: inherit !important; 
}

/* Optional: Keep the link blue ONLY when the user actually hovers over it */
.md-typeset .study_plan a:hover {
...
document.addEventListener("DOMContentLoaded", function() {
    // Define a dictionary mapping CSS selectors to their respective tooltip texts
    const tooltipMappings = {
        ".study_plan .course p:nth-child(1)>span:first-child.twemoji": "počet kreditů",
        ".study_plan .course p:nth-child(2)>span:first-child.twemoji": "hodin přednášek",
        ".study_plan .course p:nth-child(3)>span:first-child.twemoji": "hodin cvičení",
        ".assessment": "zápočet",
        ".gr_assessment": "klasifikovaný zápočet",
        ".examination": "zkouška",
        ".lecturer": "přednášející",
        ".asistent_lecturer": "cvičící",
        ".kos": "zobrazit předmět v KOSu",
        ".schedule": "rozvrh předmětu (k zobr. pouze ve správném semestru)",
    };
    
    // Loop through each selector in the dictionary
    for (const selector in tooltipMappings) {
        const tooltipText = tooltipMappings[selector];
        
        // Find all elements on the page that match the current selector
        const targetElements = document.querySelectorAll(selector);
        
        // Apply the specific title attribute to each targeted element
